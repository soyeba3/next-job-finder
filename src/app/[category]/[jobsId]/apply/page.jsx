...
const page = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-[40vh] mx-28 md:mx-14 sm:mx-4 border-[1px] bg-gray-100 border-gray-200 rounded-md">
        <form
          onSubmit={handleSubmit}
          className="flex flex-col gap-2 bg-white px-20 sm:px-5 py-10 sm:py-5 mx-40 md:mx-20 sm:m-3 my-20  rounded shadow-md"
        >
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white py-2 px-4 rounded hover:bg-[#3e9b6c] focus:outline-none focus:ring-2 focus:ring-blue-300"
          >
            Apply
          </button>
        </form>
